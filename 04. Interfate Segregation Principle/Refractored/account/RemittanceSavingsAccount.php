...
include_once 'interfaces/InternationalAmountTransferable.php';

class RemittanceSavingsAccount extends BaseAccount implements SavingsAccount, InternationalAmountTransferable {
